# MathsForge Chapter 12 - Linear Programming

A separate, static Class 12 Mathematics learning website for **Chapter 12: Linear Programming**. It is frontend-only, so it can be shared publicly through GitHub Pages without paid hosting, paid APIs, databases, or subscriptions.
