...
A separate, static Class 12 Mathematics learning website for **Chapter 12: Linear Programming**. It is part of **MathsForge** and is built as a frontend-only project, so it can be shared publicly through Netlify or GitHub Pages without paid hosting, paid APIs, databases, or subscriptions.
...
```text
https://linear-programming-forge.netlify.app/
```

GitHub Pages public website:

```text
https://armaankapoor-ship-it.github.io/mathsforge-chapter-12/
```

GitHub repository:

```text
https://github.com/armaankapoor-ship-it/mathsforge-chapter-12
```

## What Is Included

- Topic notes for Linear Programming
- Formula sheet
...
```text
Site name: linear-programming-forge
...
2. Create a new public repository named `mathsforge-chapter-12`.
